...
class Calculator implements ActionListener {
  ...
  JButton btnPlus, btnMinus, btnDiv, btnMult, btnZero, btn2Zero, btnEq, btnDec, btnAC, btnDel, btnRem;
  ...
  public Calculator() {
    ...
    btnRem = new JButton("%");
    btnRem.setFont(ff2);
    btnRem.setBackground(new Color(200, 40, 40));
